...
def bonds(rs,Nall,ltype,otype,os,res):
    ...
    [b00,b01,b02]=np.array([[b[n][0] for n in range(3)] for b in bs]).transpose()
    bsplr=mlab.quiver3d(b00,b01,b02,bv0,bv1,bv2,colormap='coolwarm',mode='cylinder',scale_factor=1.,resolution=res)
...
def plotlattice(rs,Nall,ltype,filetfig,otype='l',os=[[],[],[]],res=50,size=(5.,5.),setdpi=2000,to3d=True):
    '''
    Plot the lattice
    '''
    sos=os[0]
