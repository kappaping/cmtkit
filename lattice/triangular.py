...
def hskpoints():
    ...
    '''
    return [np.array([0.,0.,0.]),np.array([(2.*pi)/sqrt(3.),0.,0.]),np.array([-pi/sqrt(3.),pi,0.]),np.array([-pi/sqrt(3.),-pi,0]),np.array([0.,(4.*pi)/3.,0]),np.array([-(2.*pi)/sqrt(3.),-(2.*pi)/3.,0.]),np.array([(2.*pi)/sqrt(3.),-(2.*pi)/3.,0.])]
