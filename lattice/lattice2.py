...
def pairdist(ltype,r0,r1,totrsl=False,nptrs=[],tomtpl=False):
    '''
    Measure the distance between a pair of sites r0 and r1.
    Return: [Minimal distance, all r1s with minimal distance]
    '''
    # No translation.
...
def ltcpairdist(ltype,rs,Nbl,bc):
    ...
    RD=[[pairdist(ltype,r0,r1,True,nptrs) for r1 in rs] for r0 in rs]
